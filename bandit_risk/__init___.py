...
ESGBanditEnv              : 6-arm ESG retrofit selection (Week 1)
...
Quick start
-----------
>>> from bandit_risk import EpsilonGreedyAgent, ESGBanditEnv
...
>>> print(f"Discovered best arm: {agent.best_arm}")   # converges to 2 (heat pump)
"""
